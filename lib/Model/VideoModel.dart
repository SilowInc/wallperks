...
class VideoModel {
  ...
  VideoModel({this.page, this.perPage, this.videos, this.totalResults, this.nextPage, this.url});
...
class Videos {
  ...
  Videos.fromJson(Map<String, dynamic> json) {
    ...
    initializedVideoPlayerController(url!);
  }
  ...
  initializedVideoPlayerController(String url) async {
    videoPlayerController = VideoPlayerController.networkUrl(Uri.parse(url))..initialize();
  }
}
...
class VideoFiles {
  ...
  VideoFiles({this.id, this.quality, this.fileType, this.width, this.height, this.fps, this.link});
